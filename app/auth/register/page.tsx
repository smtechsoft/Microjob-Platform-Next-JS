                ...
                <button
                  ...
                  className={cn(
                    ...
                    role === r.id 
                      ...
                      : "bg-background/50 border-border/40 hover:border-primary/20 hover:bg-primary/5"
                  )}
                >
                   <div className={cn(
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <div className="relative group">
                 ...
                 <Input placeholder="John Doe" className="pl-11 rounded-xl h-12 border-border/50 bg-background font-bold" />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative group">
                 ...
                 <Input type="email" placeholder="name@example.com" className="pl-11 rounded-xl h-12 border-border/50 bg-background font-bold" />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative group">
                 ...
                 <Input type="password" placeholder="••••••••" className="pl-11 rounded-xl h-12 border-border/50 bg-background font-bold" />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative group">
                 ...
                 <Input placeholder={role === "freelancer" ? "REF-12345" : "Bulk Provider"} className="pl-11 rounded-xl h-12 border-border/50 bg-background font-bold" />
              </div>
            </div>
          </div>
